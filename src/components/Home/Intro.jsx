    ...
    >
      ...
      <div className="flex flex-col gap-3 items-center  ">
        ...
        <p className="text-xl">
          ...
          Frameworks, RAG Applications, Deep Learning, and Computer Vision. I
          have a strong passion for building intelligent systems and leveraging
          AI to solve real-world problems. Always eager to explore new
          technologies, I strive to stay at the forefront of advancements in the
          AI/ML ecosystem.
        </p>
      </div>
    </motion.div>
